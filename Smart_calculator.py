...
responses=["Welcome to smart calculator ","My name is Baka","Thanks","Sorry , this is beyound my ability"]
...
operations={"PLUS":add,"ADD":add,"ADDITION":add,
            "SUM":add,"MINUS":sub,"SUBSTRACTION":sub,"SUBTRACT":sub,"DIFFERENCE":sub,
